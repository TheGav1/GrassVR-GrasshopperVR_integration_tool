...
public class UdpReceiver : MonoBehaviour
{
    ...
    string[] lastReceivedPacket = new string[2];
    string[] previousPacket = new string[2];
    bool[] DataChanged = new bool[2];
    int dataT=0, dataV=1;
    string[] data; //conversion string2vector3 data save
    string[] sArray = new string [3];//conversion
